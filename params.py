...
alpha,kxl,kyl,g0,omega,BOx,BOy,BOz,zeta,Ri,p0 = symbols("""alpha,kxl,kyl,g0,omega,BOx,BOy,BOz,zeta,Ri,p0""")
U0,qRm,qRmm,qRmc,qRe,qRo,qFr,chi,qAl,Dist,ev,et,Rl = symbols("U0,qRm,qRmm,qRmc,qRe,qRo,qFr,chi,qAl,Dist,ev,et,Rl",real = True)
